...
class Signup extends Component {
            ...
            <Grid item>
                <Paper>
                    <Box p={2} m={5}>
                        ...
                        <Box>
                        <TextField label="College Name" onChange={this.onbgChange}></TextField>
                        </Box>

                        <Box>
                        <TextField label="Department Name" onChange={this.onallergyChange}></TextField>
                        </Box>
    ...
    onSignup = async ()=>{
        ...
        try{
        let result=await this.DMR.methods.addStudent(this.state.name,this.state.phone,this.state.gender,this.state.dob,this.state.bg,this.state.allergy).send({from:this.state.account});
        console.log(result);
