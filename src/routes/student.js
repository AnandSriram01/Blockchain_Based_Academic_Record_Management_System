...
class Student extends Component {
    ...
    getStudentInfo = async ()=>{
        try{
            let res=await this.DMR.methods.getStudentDetails(this.state.account).call({from:this.state.account});
            console.log(res);
    ...
    getStudentRecords=async ()=>{
        try{
            ...
            let res=await this.DMR.methods.getStudentRecords(this.state.account).call({from:this.state.account});
            ...
            <Grid container justify="center">
                ...
                <Paper>
                    <Box m={2} p={5}  alignItems="center" >
                        ...
                        <Box >
                            <TextField label="Other Student Address" onChange={this.onaddrChange}></TextField>
                        </Box>
                        <Box >
                            <TextField label="Professor Name" onChange={this.onhnameChange}></TextField>
                        </Box>
